    ...
    <div className="div-height" >
      <main>
        <div className="container-fluid ">
          <div className={`container col-md-9 col-sm-12 col-xs-12 ${styles.maincard} footer-height`}>
            <Row>
              <Col className={styles.leftcol}></Col>
              {signup ?
                <Col md={5} className={styles.signinmain}>
                  <div className={`col-md-12 col-sm-12 col-xs-12 ${styles.logocolor}`}>
                    <img src={Rhublogo.src} ></img>
                  </div>
                  <Row>
                    {signup ?
                ...
                : null}
              {member ?
                <Col md={5} className={styles.signupmain}>
                  <div className={`col-md-12 col-sm-12 col-xs-12 ${styles.logocolor}`}>
                    <img src={Rhublogo.src} ></img>
                  </div>
                  <Row>
