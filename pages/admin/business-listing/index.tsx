...
import {
  getActiveBusiness,
  getAllActiveBusiness,
  getAllBusiness,
  getAllInActiveBusiness,
...
const AdminBusinessAccount = (props: any) => {
            ...
            <div className={`footer-fix-height `}>
              <div>
                <div className={`${styles.wrimagecard}`}>
                  <i className="fa fa-calendar" aria-hidden="true"></i> Business Listing
                </div>
...
export default AdminBusinessAccount;