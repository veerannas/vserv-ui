...
import OverallRating from "../../components/overallratingautomotive/overallratingautomotive";
...
export default class AutomotiveProfile extends Component<any, any> {
            ...
            <div className={`container  ${styles.containerarea}`}>
              <div className={` row `}>
                ...
                <div className={` col-md-8 ${styles.rightpanel}`}>
                  ...
                  <div id="menu">
                    {/* Menu */}
                    <div className={`${styles.serviceheading}`}>Services</div>
                ...
                {/*End Left Panel */}
                <Recommendation data={this.props.data.serviceId.id} />
              </div>
            </div>
          </div>
        </main>
