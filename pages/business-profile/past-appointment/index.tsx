...
import { getBusinessPastAppointmnet, getBusinessPastAppointmnetDateBet } from "../../../components/services/api/reservation-api";
...
const Appointmenthistory = () => {
  ...
  const fetchPastAppointment = () => {
    getBusinessPastAppointmnet(cookies.get("businessInfoId"))
      .then((data) => data.json())
      .then((data) => {
