...
import { getBusinessUpcomingAppointmnet } from "../../../components/services/api/business-api";
import {
...
const UpcomingAppointment = () => {
  ...
  const fetchUpcomingAppointment = () => {
    getBusinessUpcomingAppointmnet(cookies.get("businessInfoId"))
      .then((data) => data.json())
      .then((data) => {
...
//BusinessCancelAppointmentModel Component
