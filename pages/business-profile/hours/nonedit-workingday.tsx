...
const NonEditWorkingDay = (props: any) => {
    ...
    return (
        <div className="wrapper-display">
            <Row>
                <Col md="6" className={styles.operationCol}>Operational Hours</Col>
            ...
            <Row>
                ...
                <Col as={Col} md="2">
                    <div
                        className={`form-control-border ${styles.formControlPlaceHolder}`}
                    >
                        &nbsp;  {(duration || "") == "" ? "" : <>{duration} <span>minutes</span></>} 
...
export default NonEditWorkingDay;