...
const EditForm = (props: any) => {
        ...
        getBusinessHour(cookies.get("businessInfoId"))
            ...
            .then((data) => {
                ...
                if ((workingDay[6].breakEndTime || "") !== "") {
                    ...
                    formik.values.companyData.breakTimeNone = false;
                } else {
                    formik.values.companyData.breakTimeNone = true;


                }
                if ((workingDay[6].duration || "") !== "") {
                    formik.values.companyData.duration = workingDay[6].duration;
                    formik.values.companyData.durationTimeNone = false;
                } else {
                    formik.values.companyData.durationTimeNone = true;
                ...
                formik.values.companyData.duration = data.duration;
                setCompanyData({
                    Monday: {
    ...
    const formik = useFormik({
        ...
        validationSchema: yup.object({
            companyData: yup.object().shape({
                ...
                breakStartTime: yup.string().when("breakTimeNone", {
                    is: false,
                    then: yup.string().required("Required"),
                }),
                breakEndTime: yup.string().when("breakTimeNone", {
                    is: false,
                    then: yup.string().required("Required"),
                }),
        ...
        onSubmit: (values) => {
            ...
            values.companyData.duration = values.companyData.duration;
            ...
            let workingDaysCalendar = {
                ...
                duration: values.companyData.duration
            }
    ...
    const BreakIsNone = (e: any) => {
        formik.setFieldValue(
            "companyData.breakTimeNone",
            e.target.checked
        )
        if (e.target.checked == true) {
            formik.values.companyData.breakStartTime = "";
            formik.values.companyData.breakEndTime = "";
        }
    }
    ...
    const DurationIsNone = (e: any) => {
        ...
        if (e.target.checked == true) {
            formik.values.companyData.duration = "";
        }
    }
                ...
                <br/><Row>
                    ...
                    <Col as={Col} md="3" className={`${styles.timeSelectCol}`}>
                        ...
                        <Form.Group>
                            <Form.Control
                                ...
                                readOnly={formik.values.companyData.breakTimeNone}
                    ...
                    <Col as={Col} md="2" className={`${styles.checkBoxCol}`}>
                        <Form.Check
                            ...
                            type="checkbox"
                            id="checkbox8"
                            name="companyData.breakTimeNone"
                            label="None"
                            onChange={(e) => BreakIsNone(e)}
                            checked={formik.values.companyData.breakTimeNone}
                        />
                    </Col>
                </Row>
                <br />
                    ...
                    <Col as={Col} md="3" className={`${styles.timeSelectCol}`}>
                        <Form.Group>
                            <Form.Control
                                ...
                                as="select"
                                placeholder="30 mins"
                                name="companyData.duration"
                                value={formik.values.companyData.duration}
                                onChange={formik.handleChange}
                                isInvalid={!!formik.errors.companyData?.duration}
                            ...
                            <Form.Control.Feedback type="invalid">
                                {formik.errors.companyData?.duration}
                            </Form.Control.Feedback>
                        </Form.Group>
                    </Col>
