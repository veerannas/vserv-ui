...
const HeaderNavbar = (props: any) => {
  ...
  const businessFunc = () => {
    window.location.href = "/business/business-activate";
  };
      ...
      >
        <Navbar.Brand>
          <Link href="/">
            ...
            >
              <img src={nameImg.src} className={styles.costomlogoname} alt="logo image"></img>
            </a>
          </Link>
        </Navbar.Brand>
            ...
            <Nav>
              ...
              {isVendorCount == "1" && (
                <Button
                  ...
                  onClick={(e) => (window.location.href = "/business/account")}
                >
                  Business Account
                </Button>
              )}
