...
import styles from "./overallratingfinance.module.css";
import ReviewFeedback from "../reviewfeedback/reviewfeedbackfinance";
import { Cookies } from "react-cookie";
import { getFinanceRating } from "../services/api/review-api";

const OverallRatingFinance = (props: any) => {
  ...
  const fetchTotalRevies = () => {
    //fetching data for reviews
      getFinanceRating(props.data.id)
      .then((data) => data.json())
      .then((data) => {
        ...
        overallRating.foodRating = data.averageTrustRating;
        overallRating.serviceRating = data.averageSeviceRating;
        overallRating.ambienceRating = data.averageSupportRating;
...
export default OverallRatingFinance;
