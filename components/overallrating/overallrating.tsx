...
import { getRestaurantRating } from "../services/api/review-api";

const OverallRating = (props: any) => {
  ...
  const fetchTotalRevies = () => {
    //fetching data for reviews
      getRestaurantRating(props.data.id)
      .then((data) => data.json())
      .then((data) => {
        ...
        overallRating.foodRating = data.averageFoodRating;
