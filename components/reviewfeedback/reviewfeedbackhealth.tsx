...
import { postAddHealthReview } from "../services/api/review-api";
import styles from "./reviewfeedback.module.css";

const ReviewFeedbackHealth = (props: any) => {
  const cookies = new Cookies();
  const [treatmentRating, setFoodRating] = useState(1);
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      postAddHealthReview(reviewData)
...
export default ReviewFeedbackHealth;
