...
import RestImage from "../reviewfeedback/images/restaurant.png";
import styles from "./reviewfeedback.module.css";
import { Cookies } from "react-cookie";
import * as yup from "yup";
import Ratings from "react-ratings-declarative";
import { postAddRestaurantReview } from "../services/api/review-api";

const ReviewFeedback = (props: any) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      postAddRestaurantReview(reviewData)
