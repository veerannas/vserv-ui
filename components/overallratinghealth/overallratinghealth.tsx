...
import styles from "./overallratinghealth.module.css";
import ReviewFeedback from "../reviewfeedback/reviewfeedbackhealth";
import { Cookies } from "react-cookie";
import { getHealthRating } from "../services/api/review-api";

const OverallRatingHealth = (props: any) => {
  ...
  const fetchTotalRevies = () => {
    //fetching data for reviews
      ...
      .then((data) => {
        ...
        overallRating.foodRating = data.averageTreatmentRating;
...
export default OverallRatingHealth;
